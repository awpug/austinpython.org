...
import os
def map_path(*directories):
    """ Returns the absolute path relative to current file. """
    return os.path.abspath(os.path.join(os.path.dirname(__file__), *directories))
...
SECRET_KEY = '@fk7+%h)u-(7ezug(f7wt2%52miuh9yvejdp=#kamn=evdljn-'
...
INSTALLED_APPS = (
    ...
    'austinpython.profiles',
    'austinpython.polls',
    'austinpython.registration',
    'austinpython.ap',
    "austinpython.opportunities",
)
